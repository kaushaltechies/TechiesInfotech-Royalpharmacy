export default {
  //images
  Royal_Pharmacy_Logo: require('../assets/images/royalPharmacyLogo.png'),
  ...
  cartSelect: require('../assets/icons/cartSelect.png'),
  Home: require('../assets/icons/Home.png'),
  HomeSelected: require('../assets/icons/HomeSelected.png'),
  user: require('../assets/icons/account.png'),
  userselect: require('../assets/icons/accountselect.png'),
  ...
  // STATIC iMAGES
  Slider: {
    android: require('../assets/images/SliderAndroid.png'),
    ios: require('../assets/images/SliderAndroid.png'),
    ipad: require('../assets/images/Slider.png'),
  },
